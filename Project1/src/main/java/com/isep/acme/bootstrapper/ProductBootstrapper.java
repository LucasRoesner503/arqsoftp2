...
public class ProductBootstrapper implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        //user and reviews for test
        if(userRepo.findByUsername("user12@mail.com").isEmpty()) {
            User user12 = new User("user12@mail.com", encoder.encode("userPW12"),
                    "Lucas Roesner", "748526326", "Rua doze");
