...
import com.arqsoft.project2.acmeAggregatedRatings.model.User;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    private Optional<User> getUser(String username) {
        try{
            ...
            URL endpointUrl = new URL(url + "/admin/user/username/" + username);
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests()
                ...
                .antMatchers(HttpMethod.PUT, "/reviews/**/recommended").permitAll()
                ...
                .antMatchers("/product/**/reviews").permitAll()
                .antMatchers(HttpMethod.POST, "/product/**/reviews").permitAll()
                // .hasRole(Role.RegisteredUser).anyRequest().authenticated()

                .antMatchers("/review/**/vote").permitAll();
